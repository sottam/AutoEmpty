...
namespace AutoEmpty
{
    ...
    public class Loader : LoadingExtensionBase
    {
        ...
        {
            if (mode.Equals(LoadMode.LoadGame))
            {
                GameObject go = new GameObject("Test Object");
                go.AddComponent<Monitor>();
            }
    ...
    public class Monitor : MonoBehaviour
    {
        ...
        public void Start()
        {
            InvokeRepeating("StartSearchAndEmpty", 5, 5);
        }

        public void StartSearchAndEmpty()
        {
            ...
            OutputLogger.PrintMessage("Start Scanning");
